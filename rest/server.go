...
import (
	...
	"github.com/qkja/go-zero/rest/chain"
	"github.com/qkja/go-zero/rest/handler"
	"github.com/qkja/go-zero/rest/httpx"
	"github.com/qkja/go-zero/rest/internal"
	"github.com/qkja/go-zero/rest/internal/cors"
	"github.com/qkja/go-zero/rest/internal/fileserver"
	"github.com/qkja/go-zero/rest/router"
)
...
func NewServer(c RestConf, opts ...RunOption) (*Server, error) {
	// 适配 gobase 等第三方配置加载器：gobase 反射赋值不处理 default tag，
	// 这里只对零值字段补齐 go-zero 默认值，已加载的值不受影响。
	_ = conf.FillDefaultIfZero(&c)
