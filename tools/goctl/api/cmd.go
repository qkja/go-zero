...
import (
	...
	"github.com/qkja/go-zero/tools/goctl/api/apigen"
	"github.com/qkja/go-zero/tools/goctl/api/dartgen"
	"github.com/qkja/go-zero/tools/goctl/api/docgen"
	"github.com/qkja/go-zero/tools/goctl/api/format"
	"github.com/qkja/go-zero/tools/goctl/api/gogen"
	"github.com/qkja/go-zero/tools/goctl/api/javagen"
	"github.com/qkja/go-zero/tools/goctl/api/ktgen"
	"github.com/qkja/go-zero/tools/goctl/api/new"
	"github.com/qkja/go-zero/tools/goctl/api/swagger"
	"github.com/qkja/go-zero/tools/goctl/api/tsgen"
	"github.com/qkja/go-zero/tools/goctl/api/validate"
	"github.com/qkja/go-zero/tools/goctl/config"
	"github.com/qkja/go-zero/tools/goctl/internal/cobrax"
	"github.com/qkja/go-zero/tools/goctl/plugin"
)
