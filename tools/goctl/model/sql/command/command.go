...
import (
	...
	"github.com/qkja/go-zero/core/collection"
	"github.com/qkja/go-zero/core/logx"
	"github.com/qkja/go-zero/core/stores/postgres"
	"github.com/qkja/go-zero/core/stores/sqlx"
	"github.com/qkja/go-zero/tools/goctl/config"
	"github.com/qkja/go-zero/tools/goctl/model/sql/command/migrationnotes"
	"github.com/qkja/go-zero/tools/goctl/model/sql/gen"
	"github.com/qkja/go-zero/tools/goctl/model/sql/model"
	"github.com/qkja/go-zero/tools/goctl/model/sql/util"
	file "github.com/qkja/go-zero/tools/goctl/util"
