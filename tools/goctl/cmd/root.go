...
import (
	...
	"github.com/qkja/go-zero/tools/goctl/api"
	"github.com/qkja/go-zero/tools/goctl/bug"
	"github.com/qkja/go-zero/tools/goctl/config"
	"github.com/qkja/go-zero/tools/goctl/docker"
	"github.com/qkja/go-zero/tools/goctl/env"
	"github.com/qkja/go-zero/tools/goctl/gateway"
	"github.com/qkja/go-zero/tools/goctl/internal/cobrax"
	"github.com/qkja/go-zero/tools/goctl/internal/version"
	"github.com/qkja/go-zero/tools/goctl/kube"
	"github.com/qkja/go-zero/tools/goctl/migrate"
	"github.com/qkja/go-zero/tools/goctl/model"
	"github.com/qkja/go-zero/tools/goctl/quickstart"
	"github.com/qkja/go-zero/tools/goctl/rpc"
	"github.com/qkja/go-zero/tools/goctl/tpl"
	"github.com/qkja/go-zero/tools/goctl/upgrade"
)
